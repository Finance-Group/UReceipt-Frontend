...
export class HelpComponent implements OnInit {
  ...
  listInfo: Array<Info> = [
    ...
    { id: 5, title: 'Motivos', description: 'Estos corresponden a los costes o gastos que deben pagarse al acreedor para realizar la operación, y que se descontarán del Valor Neto (diferencia entre el Valor Nominal y Descuento); estos montos afectarán al cálculo de la Tasa de Coste Efectivo Anual (T.C.E.A.).\n' + 'De acuerdo a las normas legales, será obligatorio ingresar los costes o gastos que pasan por la pasarela de pago del Banco (acreedor); sin embargo, sugerimos ingresar todos los gastos que usted realizará como consecuencia del descuento, de este modo la T.C.E.A. que resulte de dicho cálculo, será la vista desde su punto de vista y no la del acreedor.'},
    { id: 6, title: 'Valor Expresado PORCENTAJE', description: 'Esta información constituye un complemento del campo Motivo, y corresponde a la forma de enfrentar el pago de los costes o gastos que se producen para realizar la operación, que se encuentran en función del Valor Nominal y afectan al Valor Neto.\n' + '\n' + 'Si como condición del descuento debe pagar un Seguro equivalente al 0.05% del Valor Nominal, entonces deberá seleccionar la opción PORCENTAJE\n' + '\n' + 'Y digitar en el campo que se encuentra a su derecha:\n' + '\n' + '0.05'},
    { id: 7, title: 'Total a Recibir (TR)', description: 'Estos corresponden a los costes o gastos que deben pagarse al acreedor al finalizar la operación, y que se agregarán al Valor Nominal. Estos montos afectarán al cálculo de la Tasa de Coste Efectivo Anual (T.C.E.A.).\n' + 'De acuerdo a las normas legales, será obligatorio ingresar los costes o gastos que pasan por la pasarela de pago del Banco (acreedor); sin embargo, sugerimos ingresar todos los gastos que usted realizará como consecuencia del descuento, de este modo la T.C.E.A. que resulte de dicho cálculo, será la vista desde su punto de vista y no la del acreedor.\n' + '\n' + 'Por ejemplo, si debe pagar US$ 5.00 por Gastos de Administración a la finalización de la operación, entonces deberá seleccionar la opción de ADMINISTRACIÓN Si el coste o gasto no está en la relación, seleccione la opción Otros.'},
    { id: 8, title: 'Valor Expresado EFECTIVO', description: 'Esta información constituye un complemento del campo Motivo, y corresponde a la forma de enfrentar el pago de los costes o gastos que se producen para realizar la operación, que se encuentran en función del Valor Nominal y afectan al Valor Neto. \n' + '\n' + 'Si debe pagar US$ 5.00 por Gastos de Administración a la finalización de la operación, entonces deberá seleccionar la opción EFECTIVO y digitar en el campo que se encuentra a su derecha'},
